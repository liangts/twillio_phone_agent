...
export async function updatePromptTemplate(env, templateId, payload) {
  ...
  await env.DB.prepare(
    ...
    .bind(
      ...
      payload.opening_script === undefined ? existing.opening_script : payload.opening_script,
...
export async function updateOutboundLaunch(env, launchId, updates) {
  ...
  await env.DB.prepare(
    ...
    .bind(
      ...
      updates.callee_name === undefined ? existing.callee_name : updates.callee_name,
      ...
      updates.opening_script === undefined ? existing.opening_script : updates.opening_script,
